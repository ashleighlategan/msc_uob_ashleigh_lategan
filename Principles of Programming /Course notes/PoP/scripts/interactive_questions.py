...
class Question:
    ...
    def is_correct_answer(self, guess):
        ...
        return comp_answer == guess.replace("'", '"') or guess == "ß" # you found the cheat code ;)
...
class QSEFormat(QuestionFormat):
    ...
    def generate_question(self):
        ...
        local_vars = {}
        exec(formatted_exec, {}, local_vars)
        answer = out_str(eval(formatted_eval, {}, local_vars))
...
class BVFormat(QuestionFormat):
    ...
    def generate_question(self):
        ...
        exec(code_to_exec, {} , locals)
        eval_answer = out_str(eval(code_to_eval, {}, locals))
